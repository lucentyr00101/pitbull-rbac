    ...
    >
      <a-input
        ...
        v-decorator="[
          ...
          {
            rules: [
              { required: true, message: $t('error.menu-title.required') }
            ]
          }
        ]"
      />
...
export default {
  ...
  methods: {
    async showConfirmDelete () {
      this.$confirm({
        title: this.$t('messages.menu.confirm-delete'),
    ...
    async handleDelete () {
      ...
      try {
        ...
        this.showNotification(this.$t('notification.menu.deleted'))
        this.$emit('delete')
        this.$emit('refresh')
      } catch (e) {}
      this.saving = false
      ...
      this.form.validateFields(async (errors, values) => {
        if (!errors) {
          ...
          try {
            ...
            await this.$store.dispatch('menu-resources/updateMenu', data)
            this.$emit('refresh')
            this.showNotification(this.$t('notification.menu.updated'))
          } catch (e) {
            console.log(e)
