export default {
  ...
  'user.userName.required': 'Please enter valid username.',
  'user.password.required': 'Please enter valid password.',
  ...
  'user.insert.authcode': 'Enter the Google Authenticator verification code'
}
